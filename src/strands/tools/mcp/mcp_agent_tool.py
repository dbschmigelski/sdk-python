...
class MCPAgentTool(AgentTool):
    ...
    def __init__(self, mcp_tool: MCPTool, mcp_client: "MCPClient", agent_tool_name: str | None = None) -> None:
        ...
        Args:
            ...
            agent_tool_name: Optional name to use for the agent tool (for disambiguation)
        ...
        self._agent_tool_name = agent_tool_name or mcp_tool.name
